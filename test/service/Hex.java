 ...
 * @version Revision: 70 2006-07-16 21:55:08 by martijno
 * 
 * @author Pim Vullers
...
public final class Hex {
   ...
   /**
    * Java source code representation of <code>data</code>.
    *
    * @param data the byte array to print.
    *
    * @return Java source code representation of <code>data</code>.
    */
   public static String bytesToJavaHexString(byte[] data) {
      StringBuffer result = new StringBuffer();
      for (int i = 0; i < data.length; i++) {
    ...
    * @return Java source code representation of <code>data</code>.
    */
   public static String bytesToCHexString(byte[] data) {
      StringBuffer result = new StringBuffer();
      for (int i = 0; i < data.length; i++) {
         result.append("0x");
         result.append(byteToHexString(data[i]));
   ...
   public static void main(String[] args) {
       System.out.println(Hex.bytesToCHexString(Hex.hexStringToBytes(args[0])));
   }
}
